...
Model architecture is based on FCN-8 (see this [paper](https://people.eecs.berkeley.edu/~jonlong/long_shelhamer_fcn.pdf) for more information). It uses a pretrained VGG16 model.
